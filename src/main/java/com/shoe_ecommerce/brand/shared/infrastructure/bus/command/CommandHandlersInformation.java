...
import com.shoe_ecommerce.brand.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() throws URISyntaxException, ClassNotFoundException {
        indexedCommandHandlers = formatHandlers(findHandlers("com.shoe_ecommerce.brand"));
    }
