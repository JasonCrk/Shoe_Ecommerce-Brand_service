...
import com.shoe_ecommerce.brand.shared.domain.bus.query.QueryHandler;
import com.shoe_ecommerce.brand.shared.domain.bus.query.QueryNotRegisteredError;
...
public final class QueryHandlersInformation {
    ...
    public QueryHandlersInformation() throws IOException, URISyntaxException, ClassNotFoundException {
        indexedQueryHandlers = formatHandlers(findQueryHandlers("com.shoe_ecommerce.brand"));
    }
